      ...
      <div class="container col-md-12">
        ...
        <div className="col-lg-2">
          <div className="sidebar">
            <div className="sidebar-heading">Task boards</div>
            <div className="sidebar-category">Freelance Project</div>
            <div className="sidebar-category">SBI Outsource</div>
            <div className="sidebar-category">HPCL Project 1</div>
            <button className="add-new">+ Add New</button>
          </div>
        </div>
        <br/>
        
        <div className='heading col-md-10 '>My Projects</div>
        <br></br>
